            ...
            {user ? (
              <div className="mb-8">
                <h1 className="text-5xl font-bold mb-4">
                  Welcome back, <span className="text-blue-400">{user.username || user.name}</span>
                </h1>
                <p className="text-xl text-slate-300">Ready to discover your next event?</p>
              </div>
            ) : (
              <div className="mb-8">
                <h1 className="text-5xl font-bold mb-4">
                ...
                <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                  Your gateway to discovering amazing events, connecting with communities, and creating unforgettable experiences.
                </p>
              </div>
            )}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">Why Choose EventHub?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-slate-800 rounded-xl shadow-sm">
              ...
              <p className="text-slate-300">Find events that match your interests and location.</p>
            </div>
            ...
            <div className="text-center p-6 bg-slate-800 rounded-xl shadow-sm">
              ...
              <p className="text-slate-300">Join a vibrant community of event enthusiasts.</p>
            </div>
            ...
            <div className="text-center p-6 bg-slate-800 rounded-xl shadow-sm">
              ...
              <p className="text-slate-300">Create and manage your own events effortlessly.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-800 rounded-xl p-6 text-center shadow">
              ...
              <p className="text-slate-300">Explore a wide range of events tailored to your interests.</p>
            </div>
            <div className="bg-slate-800 rounded-xl p-6 text-center shadow">
              <div className="text-4xl mb-4">📝</div>
              <h4 className="text-xl font-semibold text-white mb-2">Register</h4>
              <p className="text-slate-300">Sign up for events with a single click and get instant confirmation.</p>
            </div>
            <div className="bg-slate-800 rounded-xl p-6 text-center shadow">
              <div className="text-4xl mb-4">🎉</div>
              <h4 className="text-xl font-semibold text-white mb-2">Enjoy</h4>
              <p className="text-slate-300">Attend, connect, and make memories at your chosen events.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-700 to-purple-700">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            {user?.role === 'admin' ? 'Ready to create your own event?' : 'Ready to discover amazing events?'}
          </h2>
          ...
          <Link
            to={user ? (user.role === 'admin' ? '/create-event' : '/events') : '/signup'}
          ...
          >
            {user ? (user.role === 'admin' ? 'Create Event' : 'Explore Events') : 'Get Started'}
          </Link>
        </div>
      </section>
